...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden">
      ...
      {/*  <div className="absolute inset-0 bg-repeat bg-center bg-[length:60px_60px]" */}
        <div className="absolute inset-0 bg-repeat bg-center bg-[length:32px_32px] md:bg-[length:60px_60px]"
             style={{
